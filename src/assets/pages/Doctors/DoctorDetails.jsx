...
import doctorImg from '../../images/doctor-img02.jpg'
          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-5">
              ...
              <div>
                ...
                <h3 className='text-headingColor text-[22px] leading-9 mt-3 font-bold'>Dr. Natasha Tiwari</h3>
                ...
                <p className="text_para text-[14px] leading-5 md:text-[15px] lg:max-w-[390px]">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Obcaecati  quidem libero cupiditate </p>
              </div>
            </div>
