...
import DoctorAbout from '../../assets/pages/Doctors/DoctorAbout';
          ...
          <div className='grid lg:grid-cols-3 gap-[30px] lg:gap-[50px]'>
            ...
            <div className='lg:col-span-2'>
              ...
              <div className="mt-8">
                {tab==='overview' && <div>
                    <div className="flex items-center gap-4 mb-10">
                      ...
                      <div>
                        ...
                        <p className='text_para font-[15px] lh:max-w-[390px] leading-6'>{data?.bio}</p>
                      </div>
                    </div>
                ...
                {tab==='settings' && <ProfileDoc doctorData={data}/>}
              </div>
            </div>
          </div>
        )}
