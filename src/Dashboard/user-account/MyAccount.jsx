...
import Loading from '../../components/loadernerror/Loading';
    ...
    <section>
      ...
      {!loading && !error && <div className="grid md:grid-cols-3 gap-10">
         ...
         <div className="md:col-span-2 md:px-[30px]">
            <div>
                <button className={`${tab==='bookings' && 'bg-primaryColor text-white font-normal'} p-2 mr-5 px-5 rounded-md text-headingColor font-semibold text-[16px] leading-7 border border-solid border-primaryColor`} onClick={()=>setTab('bookings')}>My Bookings</button>
                <button className={`${tab==='settings' && 'bg-primaryColor text-white font-normal'} py-2 px-5 rounded-md text-headingColor font-semibold text-[16px] leading-7 border border-solid border-primaryColor`} onClick={()=>setTab('settings')}>Profile Settings</button>
            </div>
