...
const FeedbackForm = () => {
  ...
  return (
    <form action="">
        <div>
            <h3 className=" text-headingColor leading-6 text-[16px] font-semibold mb-4 mt-0">How would you rate the overall experience?*</h3>
        ...
        <h3 className=" text-headingColor leading-6 text-[16px] font-semibold mb-4 mt-0">Share your feedback or suggestions*</h3>
