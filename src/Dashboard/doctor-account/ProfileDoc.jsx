...
import Error from '../../components/loadernerror/Error'

export default function ProfileDoc({doctorData}) {
    ...
    <div>
     ...
     <form >
        ...
        <div className="mb-5">
          <div className="grid grid-cols-3 gap-5 mb-[30px]">
            ...
            <div>
              ...
              <input type="number" name="ticketPrice" placeholder='100' value={formData.ticketPrice} className='form_input' onChange={handleInputChange}/>
            </div>
          </div>
        </div>
        ...
        <div className="mb-5">
          ...
          <button onClick={addQualification} className='bg-[#000] text-white py-2 px-5 h-fit cursor-pointer rounded-md'>Add Qualification</button>
        </div>
        ...
        <div className="mb-5">
          ...
          <button className='bg-[#000] text-white py-2 px-5 h-fit cursor-pointer rounded-md' onClick={addExperience}>Add Experience</button>
        </div>
        ...
        <div className="mb-5">
          ...
          {formData.timeSlots?.map((item,index)=><div key={index}>
            <div>
              <div className="grid grid-cols-2 md:grid-cols-4 mb-[30px] gap-5">
                ...
                <div className='flex items-center' onClick={e=>deleteTimeSlot(e,index)}>
          ...
          <button className='bg-[#000] text-white py-2 px-5 h-fit cursor-pointer rounded-md' onClick={addTimeSlot}>Add TimeSlot</button>
        </div>

        <div className="mb-5">
          <p className='form_label'>About</p>
          <textarea name="about" rows={5} value={formData.about} className='form_input' placeholder='Write about you' onChange={handleInputChange}></textarea>
        </div>
