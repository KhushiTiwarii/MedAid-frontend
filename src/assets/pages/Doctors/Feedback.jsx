...
const Feedback = () => {
  ...
  return (
    <div>
      <div className="mb-[50px]">
          ...
          <div className="flex justify-between gap-10 mb-[30px]">
            <div className="flex gap-3">
              ...
              <div>
                <h5 className="text-[16px] leading-6 text-primaryColor font-bold">Harshit</h5>
                <p className="text-[14px] leading-6 text-textColor">{formateDate("02-14-2023")}</p>
                <p className="text_para">Good Services, highly recommend 👍</p>
              </div>
            </div>
      ...
      {!showFeedbackForm && <div className="text_center"><button className="btn" onClick={()=>setShowFeedbackForm(true)}>Give Feedback</button></div>}
